...
export class DistrictController {
  ...
  @Post()
  async create(@Body() createDistrictDto: CreateDistrictDto): Promise<DistrictDocument> {
    return this.districtService.create(createDistrictDto);
  }

  @Put(':id')
  async update(@Param('id') id: string, @Body() updateDistrictDto: UpdateDistrictDto): Promise<DistrictDocument> {
